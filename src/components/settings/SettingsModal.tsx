  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-2xl bg-slate-900 border border-slate-700/80 rounded-3xl p-5 sm:p-6 shadow-2xl flex flex-col gap-4 max-h-[90vh] overflow-y-auto overscroll-contain"
      >
        {/* Modal Header */}
